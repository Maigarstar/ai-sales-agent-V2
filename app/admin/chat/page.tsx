...
export default function AdminChatHubPage() {
  ...
  const activity: Activity[] = [
    { name: "Bella Weddings Italy", note: "Submitted application", when: "2h ago" },
    ...
    >
      ...
      >
        ...
        <div style={{ marginTop: 18 }}>
          ...
          <p style={{ margin: "6px 0 0 0", fontSize: 14, color: "#555", maxWidth: 720 }}>
            Choose how you want to work with your AI concierge, you can review vendor leads, read full conversations, or step into live chat when a human reply is needed.
          </p>
        </div>
        ...
        <div style={{ marginTop: 28 }}>
          ...
          <p style={{ margin: "8px 0 0 0", fontSize: 14, color: "#666", maxWidth: 720 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr", gap: 20, marginTop: 22 }}>
          <Panel title="Lead Quality Overview" subtitle="Snapshot of AI graded leads over the past seven days.">
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, minmax(180px, 1fr))", gap: 16 }}>
              <div style={{ borderRadius: 18, backgroundColor: "#fbf8f3", padding: 22, textAlign: "center" }}>
                <div style={{ width: 14, height: 14, borderRadius: 999, margin: "0 auto", backgroundColor: "#2fbf71" }} />
                <div style={{ marginTop: 12, color: "#666" }}>Hot</div>
                <div style={{ marginTop: 6, fontSize: 28, fontWeight: 700, color: "#111" }}>9</div>
              </div>

              <div style={{ borderRadius: 18, backgroundColor: "#fbf8f3", padding: 22, textAlign: "center" }}>
                <div style={{ width: 14, height: 14, borderRadius: 999, margin: "0 auto", backgroundColor: "#f0a034" }} />
                <div style={{ marginTop: 12, color: "#666" }}>Warm</div>
                <div style={{ marginTop: 6, fontSize: 28, fontWeight: 700, color: "#111" }}>17</div>
              </div>

              <div style={{ borderRadius: 18, backgroundColor: "#fbf8f3", padding: 22, textAlign: "center" }}>
                <div style={{ width: 14, height: 14, borderRadius: 999, margin: "0 auto", backgroundColor: "#9aa3ad" }} />
                <div style={{ marginTop: 12, color: "#666" }}>Cold</div>
                <div style={{ marginTop: 6, fontSize: 28, fontWeight: 700, color: "#111" }}>5</div>
              </div>
            </div>
          </Panel>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {activity.map((a) => (
                <div key={a.name} style={{ display: "flex", justifyContent: "space-between", gap: 16 }}>
                  ...
                  <div style={{ color: "#999", fontSize: 13, whiteSpace: "nowrap" }}>{a.when}</div>
                </div>
              ))}
            </div>
          </Panel>
